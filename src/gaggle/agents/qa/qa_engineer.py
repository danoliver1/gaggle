...
from ..base import QualityAssuranceAgent, AgentContext
...
- User experience and accessibility are non-negotiable"""
    ...
    async def execute_functional_testing(
        ...
        test_results = await self.testing_tool.execute("run_functional_tests", {
    ...
    async def perform_accessibility_testing(
        self, 
        task: TaskModel, 
        accessibility_spec: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def conduct_performance_testing(
        ...
        perf_results = await self.testing_tool.execute("run_performance_tests", {
        ...
        return {
            ...
            "bottlenecks_identified": ["Database query optimization needed", "Image compression required"],
    ...
    async def perform_regression_testing(
        ...
        regression_results = await self.testing_tool.execute("run_regression_tests", {
    ...
    async def create_test_automation(
        ...
        return {
            ...
            "frameworks_used": automation_spec.get('frameworks', ['Playwright', 'pytest']),
