...
from src.gaggle.optimization.cost_optimizer import (
    CostOptimizationEngine, ModelTierOptimizer, ParallelExecutionOptimizer, 
    CachingOptimizer, CostOptimizationStrategy, OptimizationGoal
)
from src.gaggle.learning.multi_sprint_optimizer import (
    MultiSprintOptimizer, SprintLearningEngine, OptimizationStrategyGenerator
)
from src.gaggle.teams.custom_compositions import (
    TeamCompositionManager, TeamCompositionBuilder
)
...
class TestModelTierOptimizer:
    ...
    def test_analyze_role_complexity(self, sample_tasks):
        ...
        assert complexity[AgentRole.BACKEND_DEVELOPER] > complexity[AgentRole.FRONTEND_DEVELOPER]  # Higher priority/hours
    ...
    def test_calculate_cost_impact(self):
        ...
        assert impact["savings_usd"] > 0  # Should save money by using Haiku for frontend
...
class TestParallelExecutionOptimizer:
    ...
    def test_analyze_task_dependencies(self, sample_tasks):
        ...
        frontend_task_id = next(t.id for t in sample_tasks if t.task_type == "frontend_implementation")
    ...
    def test_create_execution_batches(self, sample_tasks):
        ...
        batches = optimizer.create_execution_batches(sample_tasks, dependencies, max_parallel_tasks=2)
    ...
    def test_estimate_execution_time(self, sample_tasks):
        ...
        assert analysis["total_parallel_time_seconds"] < analysis["total_sequential_time_seconds"]
...
class TestCachingOptimizer:
    ...
    def test_estimate_cache_savings(self):
        ...
        savings = optimizer.estimate_cache_savings(cacheable_operations, expected_cache_hit_rate=0.4)
...
class TestTeamCompositionManager:
    ...
    def test_optimize_composition_for_constraints(self):
        ...
        assert optimized["estimated_cost_per_sprint"] <= optimization_goals["max_budget"]
...
class TestTeamCompositionBuilder:
    ...
    def test_add_development_roles(self):
        ...
        team_with_dev_roles = builder.add_development_roles(team, project_type, constraints)
...
class TestOptimizationIntegration:
    ...
    async def test_cost_and_learning_integration(self, sample_sprint):
        ...
        learnings = await learning_engine.extract_sprint_learnings(sample_sprint, sprint_data)
        ...
        assert learnings["performance_analysis"]["cost_per_story_point"] == cost_metrics.cost_per_story_point
    ...
    async def test_team_composition_cost_optimization(self, sample_sprint):
        ...
        optimized_composition = composition_manager.optimize_composition_for_constraints(
        ...
        assert optimized_composition["estimated_cost_per_sprint"] <= constraints["budget_per_sprint"]