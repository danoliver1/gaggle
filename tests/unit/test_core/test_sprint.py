...
from src.gaggle.models.sprint import SprintModel, SprintStatus, SprintMetrics
from src.gaggle.models.story import StoryStatus
from src.gaggle.models.task import TaskStatus
...
class TestSprintModel:
    ...
    def test_start_sprint_wrong_status(self, sprint):
        ...
        with pytest.raises(ValueError, match="Can only start sprints in planning status"):
            sprint.start_sprint()
    ...
    def test_complete_sprint_wrong_status(self, sprint):
        ...
        with pytest.raises(ValueError, match="Can only complete active or in-review sprints"):
            sprint.complete_sprint()
    ...
    def test_get_stories_by_status(self, sprint, sample_user_stories):
        ...
        in_progress_stories = sprint.get_stories_by_status(StoryStatus.IN_PROGRESS.value)
    ...
    def test_get_tasks_for_story(self, sprint, sample_user_story):
        ...
        from src.gaggle.models.task import Task, TaskType, TaskComplexity
    ...
    def test_metrics_update(self, sprint, sample_user_stories):
        ...
        assert sprint.metrics.burndown_remaining == total_points - sample_user_stories[0].story_points
